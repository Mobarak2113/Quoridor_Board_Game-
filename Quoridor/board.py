...
class Board:
    ...
    def evaluate_position(self):
        ...
        wall_value = (player_wall_count-opponent_wall_count) * wall_weight
    ...
    # left
            ...
            if self.can_move_to(self.players[op],x1-1,y1) and self.can_move_to(self.players[player],x1,y1):
                new_x = x-2
